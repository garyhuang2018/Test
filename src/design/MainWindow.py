...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.stackedWidget.setGeometry(QtCore.QRect(260, 20, 771, 641))
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(10, 30, 141, 21))
        self.pushButton_3.setObjectName("pushButton_3")
        self.tableView = QtWidgets.QTableView(self.frame_2)
        self.tableView.setGeometry(QtCore.QRect(0, 70, 771, 551))
        self.tableView.setObjectName("tableView")
        self.comboBox = QtWidgets.QComboBox(self.frame_2)
        self.comboBox.setGeometry(QtCore.QRect(670, 40, 101, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "自动录入音频参数"))
